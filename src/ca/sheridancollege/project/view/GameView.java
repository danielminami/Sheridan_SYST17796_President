        ...
        Scanner in = new Scanner(System.in);
         do{
            ...
            System.out.println("\u2022 52 Cards will be dealt evenly across "
                    + "all 4 players\n");
            System.out.println("\u2022 The player with the 3 of clubs plays "
                    + "first (Must play 3 of clubs)\n");
            ...
            System.out.println("   \u2022 The player who starts a trick, "
                ...
                System.out.println("   \u2022  All other players pass, the "
                        + "last player to play starts the next trick.");
                System.out.println("   \u2022 Playing a 2, that player starts "
                        + "the next trick\n");
